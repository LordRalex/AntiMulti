...
public class Help {
    ...
    {
        {
            if (input != null && (input.isOp() || (AntiMulti.perms != null && AntiMulti.perms.has(input, "antimulti.cmd")) || input.hasPermission("antimulti.cmd"))) {
        ...
        if(args.length == 0)
        {
            ...
            {
                if ((AntiMulti.perms != null && AntiMulti.perms.has(input, "antimulti.cmd. " + CommandListener.cmds[i])) || input.hasPermission("antimulti.cmd." + CommandListener.cmds[i])) {
